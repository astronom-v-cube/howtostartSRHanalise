...
Для выхода из spyder можно использовать `ctrl + z`, для выхода из виртуального окружения используем
